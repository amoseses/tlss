...
Add the people and dates. Givit helps you pick bright, thoughtful gifts before the day sneaks up.
      ...
      <section className="border-b border-border/50 bg-givit-sand/40">
        <div className="container grid gap-6 py-10 sm:grid-cols-3">
          {[
            { icon: Brain, title: "Short AI questionnaire", desc: "Recipient, date, budget, vibe. That’s it." },
            { icon: Bell, title: "Notification system", desc: "5–6 week prompts before important dates." },
            { icon: PackageCheck, title: "Approval-to-order", desc: "Approve once; admin handles the rest." },
          ].map((item) => (
