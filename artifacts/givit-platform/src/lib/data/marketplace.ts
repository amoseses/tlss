...
const GENERATED_IDEAS = Object.entries({
  ...
  art: [
    ...
    ["museum-membership-credit", "Local Museum Membership Credit", "GIVIT Experiences", 10000, "Admin sourced", "", ["art", "culture", "experience"], "Admin-sourced museum membership or pass.", "Turns an art interest into real weekends out.", "Culture pass"],
  ],
  food: [
  ...
  experiences: [
    ["private-pottery-class", "Private Pottery Wheel Class", "GIVIT Experiences", 14000, "Admin sourced", "", ["art", "date night", "experience"], "Local pottery session sourced by the concierge team.", "Hands-on and memorable without adding clutter.", "Date night"],
    ["jazz-club-night", "Jazz Club Night Out", "GIVIT Experiences", 16000, "Admin sourced", "", ["music", "night out", "experience"], "Tickets or gift card for a nearby jazz club.", "Feels personal when music is in their profile.", "Live music"],
    ["chef-table-credit", "Chef's Table Dinner Credit", "GIVIT Experiences", 25000, "Admin sourced", "", ["food", "romantic", "experience"], "Concierge-sourced dinner credit for a standout local spot.", "A strong anniversary or milestone gift.", "Dinner plan"],
    ["botanical-garden-membership", "Botanical Garden Membership", "GIVIT Experiences", 9000, "Admin sourced", "", ["plants", "outdoor", "family"], "Membership or passes to a nearby garden.", "Great for plant lovers and low-pressure outings.", "Garden pass"],
    ["sports-ticket-credit", "Sports Ticket Credit", "GIVIT Experiences", 18000, "Admin sourced", "", ["sports", "event", "experience"], "Ticket budget for a team, match, or game they care about.", "Lets admin source around team, city, and schedule.", "Game day"],
  ],
