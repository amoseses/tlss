...
const BETA_GOALS = [
  { icon: Sparkles, title: "Your Gift AI", body: "Tell us where recommendations feel magical, generic, or missing context." },
...
const TESTING_AREAS = ["Your Gift AI", "Marketplace browsing", "Gift boards", "AutoGift / concierge", "Account setup", "Seller or product submission"];
