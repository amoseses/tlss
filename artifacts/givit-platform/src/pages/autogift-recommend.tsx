    ...
    <PageShell>
      <div className="mx-auto max-w-3xl rounded-2xl border border-givit-ember/20 bg-gradient-to-br from-givit-coral/20 via-givit-ember/10 to-givit-coral/5 p-6 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">
          Answer a few quick prompts and Your Gift AI will create three clear options (bundles or one standout gift) with exact items, links, photos, pricing, and approval before anything is ordered.
        </p>
