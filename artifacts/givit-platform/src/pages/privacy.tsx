    ...
    <PageShell narrow>
      ...
      <div className="prose prose-sm max-w-none text-foreground space-y-6">
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-7 text-muted-foreground">Queries you send to Your Gift AI are processed to generate gift recommendations. We may use anonymised, aggregated patterns to improve recommendation quality. We do not use your personal messages to train third-party AI models.</p>
        </section>
        <section>
