...
const TAG_MAP: Record<string, string[]> = {
  ...
  grandmother: ["home", "comfort", "reading", "family", "kitchen", "plants"],
  grandpa: ["home", "comfort", "reading", "family", "outdoor", "tools"],
  grandfather: ["home", "comfort", "reading", "family", "outdoor", "tools"],
  sister: ["friend", "beauty", "self care", "creative", "lifestyle"],
  brother: ["friend", "gaming", "tech", "fitness", "outdoor"],
  aunt: ["home", "self care", "kitchen", "reading"],
  uncle: ["outdoor", "tools", "tech", "coffee"],
  cousin: ["friend", "fun", "gaming", "creative"],
  girlfriend: ["partner", "romantic", "beauty", "self care", "keepsake"],
  boyfriend: ["partner", "tech", "gaming", "fitness", "outdoor"],
  fiance: ["partner", "romantic", "home", "keepsake"],
  neighbor: ["home", "food", "plants", "neutral"],
  baby: ["kid", "toys", "comfort", "keepsake"],
  teen: ["gaming", "tech", "creative", "music"],
  teenager: ["gaming", "tech", "creative", "music"],
  ...
  chef: ["kitchen", "cooking", "food", "hosting"],
  baking: ["kitchen", "dessert", "cooking", "food"],
  baker: ["kitchen", "dessert", "cooking", "food"],
  yoga: ["fitness", "wellness", "self care", "recovery"],
  running: ["fitness", "running", "training", "wellness"],
  runner: ["fitness", "running", "training", "wellness"],
  hiking: ["outdoor", "camping", "adventure", "travel"],
  hiker: ["outdoor", "camping", "adventure", "travel"],
  camping: ["outdoor", "camping", "adventure"],
  fishing: ["outdoor", "adventure", "nature"],
  pets: ["pets", "dogs", "cats", "home"],
  dog: ["pets", "dogs", "home"],
  cat: ["pets", "cats", "home"],
  tea: ["tea", "cozy", "kitchen", "self care"],
  wine: ["hosting", "food", "kitchen", "experience"],
  cocktails: ["hosting", "kitchen", "food"],
  plants: ["plants", "garden", "home", "nature"],
  photography: ["creative", "art", "tech", "travel"],
  crafts: ["crafts", "creative", "art", "making"],
  knitting: ["crafts", "creative", "cozy"],
  sewing: ["crafts", "creative", "making"],
  movies: ["entertainment", "cozy", "fun"],
  podcasts: ["audio", "tech", "entertainment"],
  fashion: ["lifestyle", "beauty", "design"],
  sports: ["sports", "fitness", "outdoor", "training"],
  golf: ["sports", "outdoor", "fitness"],
  cycling: ["fitness", "outdoor", "sports", "training"],
  swimming: ["fitness", "sports", "training"],
  board: ["gaming", "play", "friends", "fun"],
  puzzle: ["gaming", "play", "fun", "creative"],
  wellness: ["wellness", "self care", "recovery", "fitness"],
  spa: ["self care", "beauty", "wellness", "experience"],
  cozy: ["cozy", "home", "comfort", "reading"],
  minimalist: ["organization", "design", "neutral", "useful"],
  foodie: ["food", "kitchen", "cooking", "snacks", "hosting"],
  hosting: ["hosting", "kitchen", "food", "home"],
  organization: ["organization", "desk setup", "home", "useful"],
  ...
  "mother's day": ["parent", "self care", "home", "keepsake"],
  "father's day": ["parent", "outdoor", "tools", "tech"],
  valentine: ["romantic", "keepsake", "self care", "experience"],
  hanukkah: ["holiday", "cozy", "giftable"],
  promotion: ["professional", "office", "milestone", "desk setup"],
  "thank you": ["giftable", "neutral", "food", "useful"],
  "get well": ["comfort", "cozy", "self care", "wellness"],
  experience: ["experience", "memories", "date night", "local"],
  memories: ["experience", "keepsake", "memories"],
  budget: ["useful", "giftable", "fun"],
};
